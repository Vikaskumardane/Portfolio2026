...
const skillCategories = [
  {
    ...
    skills: [
      { name: "AWS (EC2, RDS, S3, Lambda, VPC)", level: "Expert", score: 5 },
      { name: "Terraform", level: "Advanced", score: 4 },
      { name: "Docker & Kubernetes", level: "Advanced", score: 4 },
      { name: "Prometheus", level: "Intermediate", score: 3 },
    ],
  },
  {
    title: "CI/CD & Tools",
    ...
    skills: [
      { name: "GitHub Actions", level: "Expert", score: 5 },
      { name: "Jenkins", level: "Advanced", score: 4 },
      { name: "Snyk", level: "Intermediate", score: 3 },
      { name: "Git & ServiceNow", level: "Expert", score: 5 },
    ],
  },
  {
    title: "Backend",
    ...
    skills: [
      { name: "Spring Boot & Framework", level: "Advanced", score: 4 },
      { name: "Node.js & Express", level: "Advanced", score: 4 },
      { name: "RESTful APIs", level: "Expert", score: 5 },
      { name: "Microservices", level: "Advanced", score: 4 },
    ],
  },
  {
    title: "Frontend",
    ...
    skills: [
      { name: "React & Next.js", level: "Advanced", score: 4 },
      { name: "Vue.js", level: "Intermediate", score: 3 },
      { name: "Tailwind CSS", level: "Expert", score: 5 },
      { name: "Responsive Design", level: "Expert", score: 5 },
    ],
  },
  {
    title: "Languages",
    ...
    skills: [
      { name: "Java", level: "Advanced", score: 4 },
      { name: "JavaScript & TypeScript", level: "Expert", score: 5 },
      { name: "Python", level: "Intermediate", score: 3 },
      { name: "SQL", level: "Advanced", score: 4 },
    ],
  },
  {
    title: "Databases",
    ...
    skills: [
      ...
      { name: "Firebase", level: "Intermediate", score: 3 },
      { name: "Prisma", level: "Advanced", score: 4 },
    ],
  },
];
